                    ...
                    <div class="p-4 bg-[#020617] border border-[#1e293b] rounded-xl">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <label class="relative cursor-pointer">
                                ...
                                <div class="p-3 text-center rounded-xl border-2 border-[#334155] bg-[#0F172A] transition-all duration-200
                                            peer-checked:border-[#94a3b8] peer-checked:bg-[#1e293b] hover:border-[#94a3b8]/50">
                                    <span class="block text-sm font-bold text-[#e2e8f0]">Reguler</span>
                                    <span class="block text-[10px] text-[#94a3b8] mt-1">Tarif Normal</span>
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                                ...
                                <div class="p-3 text-center rounded-xl border-2 border-[#334155] bg-[#0F172A] transition-all duration-200
                                            peer-checked:border-cyan-500 peer-checked:bg-cyan-500/10 hover:border-cyan-500/40">
                                    <span class="block text-sm font-bold text-cyan-400">VIP</span>
                                    <span class="block text-[10px] text-[#94a3b8] mt-1">Gratis, Denda Tetap</span>
                                </div>
                            </label>
                            <label class="relative cursor-pointer">
                                <input wire:model="status_spesial" type="radio" value="vvip" class="sr-only peer">
                                <div class="p-3 text-center rounded-xl border-2 border-[#334155] bg-[#0F172A] transition-all duration-200
                                            peer-checked:border-amber-500 peer-checked:bg-amber-500/10 hover:border-amber-500/40">
                                    <span class="block text-sm font-bold text-amber-400">VVIP</span>
                                    <span class="block text-[10px] text-[#94a3b8] mt-1">Gratis Total 100%</span>
                                </div>
                            </label>
                        </div>
                    </div>
