    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 mb-6">
        ...
        <div class="flex flex-wrap items-end gap-4">
            ...
            <a href="{{ route('owner.laporan.cetak', ['tanggal_mulai' => $tanggal_mulai, 'tanggal_selesai' => $tanggal_selesai, 'search' => $search]) }}" 
               target="_blank"
               class="px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-xl shadow-lg shadow-emerald-500/25 transition-all duration-300 flex items-center gap-2 ml-auto">
