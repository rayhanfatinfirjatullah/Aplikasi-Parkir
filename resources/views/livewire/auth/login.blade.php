<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 px-4">
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white tracking-tight">Aplikasi Parkir</h1>
            <p class="text-blue-200/70 mt-2">Sistem Manajemen Parkir - UKK 2025/2026</p>
        </div>
        ...
        <!-- Footer -->
        <p class="text-center text-blue-200/40 text-sm mt-6">&copy; {{ date('Y') }} Aplikasi Parkir - UKK 2025/2026</p>
    </div>
</div>
